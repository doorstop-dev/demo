"""Unit tests for the demo.core.item module."""
...
from demo.core.item import Item

from demo.core.test import ENV, REASON
from demo.core.test import FILES, EMPTY, EXTERNAL, MockFileObject
...
class TestItem(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_init_invalid(self):
        ...
        self.assertRaises(DemoError, Item, 'not/a/path')
    ...
    def test_load_error(self):
        ...
        self.assertRaises(DemoError, self.item.load)
    ...
    def test_find_ref_error(self):
        ...
        self.assertRaises(DemoError, self.item.find_ref, root=EMPTY)

    @unittest.skipUnless(os.getenv(ENV), REASON)
    def test_find_ref_error_long(self):
        """Verify an error occurs when no external reference found (long)."""
        self.item.ref = "not found".replace(' ', '')  # avoids self match
        self.assertRaises(DemoError, self.item.find_ref)
    ...
    def test_invalid_file_name(self):
        ...
        self.assertRaises(DemoError, MockItem, "path/to/REQ.yaml")
        self.assertRaises(DemoError, MockItem, "path/to/001.yaml")

    def test_invalid_file_ext(self):
        """Verify an invalid file extension cannot be a requirement."""
        self.assertRaises(DemoError, MockItem, "path/to/REQ001")
        self.assertRaises(DemoError, MockItem, "path/to/REQ001.txt")

    @patch('demo.core.item.Item', MockItem)
    def test_new(self):
    ...
    def test_valid_invalid_ref(self):
        ...
        with patch('demo.core.item.Item.find_ref',
                   Mock(side_effect=DemoError)):
...
class TestModule(unittest.TestCase):  # pylint: disable=R0904
    ...
    """Unit tests for the demo.core.item module."""  # pylint: disable=C0103
