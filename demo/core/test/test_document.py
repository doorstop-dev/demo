"""Unit tests for the demo.core.document module."""
...
from demo.core.test import ENV, REASON
from demo.core.test import ROOT, FILES, EMPTY, NEW, MockFileObject
from demo.core.test.test_item import MockItem
...
@patch('demo.core.item.Item', MockItem)  # pylint: disable=R0904
class TestDocument(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_init_invalid(self):
        ...
        self.assertRaises(DemoError, Document, 'not/a/path')
    ...
    def test_load_error(self):
        ...
        self.assertRaises(DemoError, self.document.load)
    ...
    @patch('demo.core.document.Document', MockDocument)
    def test_new(self):
    ...
    def test_new_existing(self):
        ...
        self.assertRaises(DemoError, Document.new, FILES, ROOT, 'DUPL')

    def test_invalid(self):
        """Verify an exception is raised on an invalid document."""
        self.assertRaises(DemoError, Document, EMPTY)
    ...
    def test_find_item_unknown_number(self):
        ...
        self.assertRaises(DemoError, self.document.find_item, 'req99')

    def test_find_item_unknown_ID(self):
        """Verify an exception is raised on an unknown ID."""
        self.assertRaises(DemoError, self.document.find_item, 'unknown99')

    @patch('demo.core.item.Item.issues')
    def test_valid(self, mock_issues):
        """Verify a document can be validated."""
        mock_issues.return_value = [DemoInfo('i')]
    ...
    @patch('demo.core.item.Item.issues', Mock(return_value=[]))
...
class TestModule(unittest.TestCase):  # pylint: disable=R0904
    ...
    """Unit tests for the demo.core.document module."""  # pylint: disable=C0103
