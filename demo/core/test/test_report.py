"""Unit tests for the demo.core.report module."""
...
from demo.core.vcs.mockvcs import WorkingCopy
from demo.common import DemoError
from demo import settings

from demo.core.test import FILES, ENV, REASON
...
class TestModule(unittest.TestCase):  # pylint: disable=R0904
    ...
    """Unit tests for the demo.core.report module."""  # pylint: disable=C0103
