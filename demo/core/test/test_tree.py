"""Unit tests for the demo.core.tree module."""
...
from demo.core.tree import Tree, build
from demo.core.document import Document

from demo.core.test import ENV, REASON, FILES, SYS, EMPTY
from demo.core.test.test_document import MockDocument as _MockDocment
...
@patch('demo.core.document.Document', MockDocument)  # pylint: disable=R0904
class TestTreeStrings(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_from_list_no_root(self):
        ...
        b.parent = 'A'
        docs = [a, b]
        self.assertRaises(DemoError, Tree.from_list, docs)
...
@patch('demo.core.document.Document', MockDocument)  # pylint: disable=R0904
@patch('demo.core.tree.Document', MockDocument)  # pylint: disable=R0904
...
class TestModule(unittest.TestCase):  # pylint: disable=R0904
    ...
    """Unit tests for the demo.core.tree module."""  # pylint: disable=C0103
    ...
    @patch('demo.core.document.Document', MockDocumentNoSkip)
    @patch('demo.core.vcs.find_root', Mock(return_value=FILES))
    def test_build(self):
