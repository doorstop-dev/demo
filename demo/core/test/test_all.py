"""Tests for the demo.core package."""
...
from demo.core.test import ENV, REASON, ROOT, FILES, EMPTY
...
class TestTree(unittest.TestCase):  # pylint: disable=R0904
    ...
    @patch('demo.core.document.Document', DocumentNoSkip)
...
class TestModule(unittest.TestCase):  # pylint: disable=R0904
    ...
    """Integration tests for the demo.core module."""  # pylint: disable=C0103
